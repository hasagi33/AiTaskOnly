...
from CustomHuberLoss import CustomHuberLoss
...
class TaskDurationModel:
    def __init__(self, input_size=47):
        ...
        match Config.current_loss:
            case 1:
                self.loss_function = CustomHuberLoss(delta=1.0)
    def forward(self, X):
        match Config.current_layers:
            case 1:
        ...
        return None             #If this happens, a big big mistake was made
